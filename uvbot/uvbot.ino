...
const char* ssid = "Monica_AP";     // your network SSID (name)
const char* password = "POIaxp_monica"; // your network key

#define BOTtoken "1221899756:AAEaBYa25-E7jMIFf3lo05I_SxfHpPaaeCY"  // your Bot Token (Get from Botfather)
